        ...
        //                }
            ...
            if(selectedReportType == null || selectedReportType == ""){
                ...
                case "donationInkindDetail":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Donation_In_Kind_Donation_Report_Detail&");
                    break;
                
                case "donationReceiptDetail":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Donation_Receipt_Donation_Report_Detail&");
                    break;
                
                case "donorSetupDetail":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Donor_Setup_Donationl_Report_Detail&");
                    break;
                ...
                switch (selectedCatReportType) {
                    ...
                    case "summarydonationdonor":
                            reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Summary_Donation_Donor_Wise_Report&");
                            break;
                        
                    case "summarydonationcategoryday":
                            reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Summary_Donation_Category_Day_Wise_Report&");
                            break;
                    case "summarydonationcategorymonth":
                            reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Summary_Donation_Category_Month_Wise_Report&");
                            break;
                    case "summarydonationcategorydonor":
                            reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Summary_Donation_Category_Donor_Wise_Report&");
                            break;
