...
//        }
        ...
        if (gotFormat == "") {
            showMessage("Please Select Report Format");
                ...
                case "payableAgeingReport":
                    reportBean.setReportURLName("userid=irsc/irscir@orcl&domain=classicdomain&report=C:/IRSC_Reports/Payable_Ageing_Report&");
                    break;
                
                case "receivableAgeingReport":
                    reportBean.setReportURLName("userid=irsc/irscir@orcl&domain=classicdomain&report=C:/IRSC_Reports/Receivable_Ageing_Report&");
                    break;
