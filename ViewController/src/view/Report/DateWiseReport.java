    ...
    public String gen_Report() {
        ...
        if (gotFormat == "") {
            showMessage("Please Select Report Format");
                ...
                case "cashPurchase":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Cash_Purchase_Date_Wise&");
                    break;
                
                case "debitNotes":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Debit_Notes_Date_Wise&");
                    break;
                
                case "demandOrder":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Demand_Order_Date_Wise&");
                    break;
                
                case "goodsIssue":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Good_Issue_Notes_Date_Wise&");
                    break;
                
                case "goodsReceipt":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Good_Receipt_Notes_Date_Wise&");
                    break;
                
                case "interTransfer":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Inter_Transfer_Notes_Date_Wise&");
                    break;
                
                case "inwardGatePass":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Inward_Gate_Pass_Date_Wise&");
                    break;
                
                case "purchaseOrder":
                    reportBean.setReportURLName("userid=irsc/irsc@orcl&domain=classicdomain&report=C:/IRSC_Reports/Purchase_Order_Date_Wise&");
                    break;
